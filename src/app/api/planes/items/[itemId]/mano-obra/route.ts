...
export async function PATCH(req: NextRequest, ctx: RouteContext<"/api/planes/items/[itemId]/mano-obra">) {
  try {
    ...
    const data = await planesService.actualizarManoObraDeItem(actor, requireIntParam(itemId, "itemId"), horas);
